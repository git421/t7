...
public class Frases extends javax.swing.JFrame {
    ...
    public void imprimeFrases() {
        this.jTextArea1.setText("Frases: \n");
        this.jTextArea1.append("-----------------------------\n");
        for (int i = 0; i < arrayNombres.length; i++) {
            String nombre = arrayNombres[i];
            if (nombre != null) {
                //System.out.println(i+": "+nombre);
                this.jTextArea1.append(nombre + "\n");
            }
        }
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Mostrar Frases");
...
//        this.jTextField1.setText("");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        this.jTextArea1.setText("Frase mas larga: " + (maxpos) + "- "+arrayNombres[maxpos]);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        this.jTextArea1.setText("Frase mas corta: " + (minpos) +"- "+ arrayNombres[minpos]);
