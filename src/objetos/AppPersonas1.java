 ...
 * @author cissanal
 */
public class AppPersonas1 extends javax.swing.JFrame {
    ...
    private void llenarLista(){
        ...
        for (Persona persona : personas) {
            modeloLista.addElement(personas);
        }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Mayores de edad");
        ...
        jButton5.setText("Ordenar por Edad");
...
//        personas[posicion]=p;
        ...
        posicion++;
        //lo almacenamos tambien en el modelo de la lista
...
////            });
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        for (Persona persona : personas) {
            contador2++;
            if(persona.getNombre().equalsIgnoreCase(busqueda)){
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        Arrays.sort(personas,0,posicion); //ordenacion por nombre, orden natural
        mostrarArray();
        llenarLista();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        Arrays.sort(personas,0, posicion, new OrdenPorEdad()); //ordenacion por edad, orden total
        mostrarArray();
        llenarLista();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AppPersonas1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AppPersonas1().setVisible(true);
            }
        });
    }
